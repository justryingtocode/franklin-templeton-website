...
@Component({
  selector: 'app-wishcenter',
  templateUrl: './wishcenter.component.html',
  styleUrls: ['./wishcenter.component.scss']
})
export class WishcenterComponent {
...
getData:any = [
  ...
  ngOnInit(): void {
    this.getData.forEach(() => {
      ...
      this.showIconForWatchlist.push(false);
    });
    this.getMockFunds();
  }
