...
@Component({
  selector: 'app-disclosure-steps',
  templateUrl: './disclosure-steps.component.html',
  styleUrls: ['./disclosure-steps.component.scss']
})
export class DisclosureStepsComponent implements OnInit, AfterViewInit {
  ...
  stepperArray: Array<any> = [     // This is to check whether we have passed a particular stepper step.
    {
      "id": 1,
      "hasTraversed": false
    },
