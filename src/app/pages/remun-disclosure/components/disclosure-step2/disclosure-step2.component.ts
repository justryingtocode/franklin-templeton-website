...
@Component({
  selector: 'app-disclosure-step2',
  templateUrl: './disclosure-step2.component.html',
  styleUrls: ['./disclosure-step2.component.scss']
})
export class DisclosureStep2Component implements OnInit{
