...
@Component({
  selector: 'app-reset-step1',
  templateUrl: './reset-step1.component.html',
  styleUrls: ['./reset-step1.component.scss']
})
export class ResetStep1Component implements OnInit, AfterViewInit {
